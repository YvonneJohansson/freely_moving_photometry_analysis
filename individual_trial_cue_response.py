...
import pandas as pd
import pickle
from utils.nacc_individual_trial_analysis_utils import cueTracesZScored
# NAcc recordings
mouse = 'SNL_photo19'
...
for date in dates:
    ...
    behavioural_params = cueTracesZScored( fiber_side, mouse, date)
    behavioural_params.get_peaks(dff, trial_data)
    mean_and_sem_filename = mouse + '_' + date + '_' + 'peaks_cue_data.p'
